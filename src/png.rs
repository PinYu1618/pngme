...
impl Png {
    ...
    pub fn from_chunks(chunks: Vec<Chunk>) -> Self {
        let head_type = ChunkType::from_str("IHDR").unwrap();
        let tail_type = ChunkType::from_str("IEND").unwrap();
        let head_chunk = Chunk::new(head_type, Vec::new());
        let tail_chunk = Chunk::new(tail_type, Vec::new());
        let mut chunks = chunks;
        chunks.insert(0, head_chunk);
        chunks.push(tail_chunk);
        Self {
